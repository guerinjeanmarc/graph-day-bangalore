# BT Graph Day Bangalore 2023 - Workshop Digital Twin

This repository contains the material used during the **BT Graph Day Bangalore 2023 - Building a Graph Solution Workshops**. 
...
If you want to replay the workshop later, you will need to build your own demo environment:
...
In these queries, we're going to look at finding the Shortest Path from Stockholms to Malmö. 
